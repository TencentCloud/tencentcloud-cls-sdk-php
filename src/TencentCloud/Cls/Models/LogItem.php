...
namespace TencentCloud\Cls\Models;

/**
 * TencentCloud_Log_Models_LogItem used to present a log, it contains log time and multiple
...
class LogItem {
    ...
    /**
     * Aliyun_Log_Models_LogItem constructor
     *
